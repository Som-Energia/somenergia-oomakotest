<%
    ...
    if (object.__hasattr__('proces_id') and object.proces_id.name == 'M1') and object.__hasattr__('step_ids') and len(object.step_ids) > 0 and object.step_ids[0].pas_id.dades_client.lang:

...
<%def name="correu_cat()">
    ...
    <p>
        Seguiu interessats amb el canvi?
    </p>
    <p>
...
<%def name="correu_es()">
    ...
    <p>
        Som Energia no puede ofrecer el bono social por lo que si cambias a la cooperativa el contrato perderás la bonificación actual.
    </p>
    <p>
        Seguís interesados con el cambio?
    </p>
    <p>

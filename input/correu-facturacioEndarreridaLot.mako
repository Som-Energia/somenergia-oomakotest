...
T’escrivim en relació a la facturació del teu contracte ${object.polissa_id.name} amb Som Energia. A causa d’una incidència informàtica, la facturació va quedar encallada fa uns mesos.<br>
<br>
Et demanem disculpes i ara solucionem la causa d’aquest bloqueig.<br>
<br>
En els propers 2-3 dies rebràs les factures que posen al dia la facturació. Et preguem que esperes a rebre-les totes per a revisar-les.<br>
<br>
...
% endif
% if  object.polissa_id.titular.lang != "ca_ES":
Te escribimos en relación a tu contrato ${object.polissa_id.name} con Som Energia. Debido a una incidencia informática, la facturación quedó bloqueada desde hace unos meses.<br>
<br>
Te pedimos disculpas y ahora solucionamos la causa de este bloqueo.<br>
<br>
En los próximos 2-3 días recibirás las facturas que ponen al día la facturación. Te pedimos que esperes a recibirlas todas para revisarlas.<br>
<br>

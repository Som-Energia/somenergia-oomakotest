...
<%def name="correu_cat()">
    ...
    <p><strong>Ara, per quedar-te, t’hauries de <a target='_blank' href='https://www.somenergia.coop/ca/fes-te-n-soci-a/'>fer soci/a</a> o bé que una altra persona sòcia t’aculli.</strong></p>
    <p class='align-center'><a class='button' target='_blank' href='https://www.somenergia.coop/ca/fes-te-n-soci-a/'>Em vull associar!</a></p>
    <p>Si coneixes alguna altra persona sòcia, li pots demanar que t’aculli. Això a ella no li implica res, ni es farà responsable ni tindrà informació de cap tema relacionat amb el teu contracte. Simplement hauria de deixar-te el seu número de sòcia i DNI o NIE. I, quan els tinguis, segueixes <a target='_blank' href='https://ca.support.somenergia.coop/article/1221-com-vincular-un-contracte-a-una-persona-socia#vincular'>aquests passos</a>.</p>
    <p>Al nostre Centre d’Ajuda pots veure <strong><a target='_blank' href='https://ca.support.somenergia.coop/article/1221-com-vincular-un-contracte-a-una-persona-socia#vincular'>com vincular el contracte</a> a una altra persona sòcia</strong>.</p>
    <p>I si no coneixes cap altra persona sòcia, pots acostar-te a alguna sòcia activa (<a target='_blank' href='https://www.somenergia.coop/ca/cooperativa/grups-locals'>Sòcies Activistes</a>) o bé escriure’ns a participa@somenergia.coop.</p>
    <p>
        Com ja et vam explicar quan vas entrar, aquesta situació especial només pot durar un any. <strong>Si no t’associes o vincules el teu contracte abans de 30 dies, no se’t podrà renovar el contracte d’electricitat</strong>. Aleshores:
        <ul>
...
<%def name="correu_es()">
    ...
    <p>Y si no conoces a otra persona socia, puedes acercarte a alguna socia activa (<a target='_blank' href='https://www.somenergia.coop/es/cooperativa/grupos-locales'>Socias Activistas</a>) o escribirnos a participa@somenergia.coop.</p>
    <p>
        Como ya te contamos cuando entraste, esta situación especial sólo puede durar un año. <strong>Si no asocias ni vinculas tu contrato antes de 30 días, no se podrá renovar el contrato de electricidad</strong>. Entonces:
        <ul>

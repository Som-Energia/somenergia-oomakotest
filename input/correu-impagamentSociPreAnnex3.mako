...
En poc temps, si no liquides les factures pendents, l'empresa distribuïdora tallarà el teu subministrament de llum per impagament. Per evitar-ho, sempre que et trobis en una situació de vulnerabilitat econòmica, i en compliment de la legislació vigent (Reial decret 897/2017, de 6 d’octubre, pel qual es regula la figura del consumidor vulnerable, el bo social i altres mesures de protecció per als consumidors domèstics d’energia elèctrica), <b>podries evitar el tall de llum</b> si el teu contracte passa a la <b>comercialitzadora de referència</b>.<br/>
<br/>
Som Energia, per llei, no pot aplicar cap tarifa social ni evitar el tall de llum, lamentablement, si no et passes a una comercialitzadora de referència i les factures no es regularitzen, haurem d'iniciar el protocol de tall de subministrament. <br/>
<br/>
Si és el cas, t'agrairem que ens contestis aquest correu i ens donis el teu consentiment per donar de baixa el teu contracte (número ${object.polissa_id.name}), del subministrament elèctric del c. ${object.cups_id.direccio}. D'aquesta manera la distribuïdora t'assignarà una comercialitzadora de referència i podràs acollir-te als beneficis que et comentem. <br/>
<br/>
Et recordo el deute pendent:<br/>
<br/>
...
<br/>
En el concepte de la transferència indica'ns, si us plau, el número del teu contracte: ${object.polissa_id.name}<br/>
<br/>
Salutacions,<br/>
<br/>
...
<br/>
Si no quieres disfrutar del bono social envíanos, por favor, un correo para confirmarnos tu renuncia. Pero te expones a un corte de suministro si las facturas no se regularizan.<br/>
<br/>
Para cambiar de comercializadora puedes hacer el trámite tu mismo contactando con ella. Sin embargo, si quieres que lo gestione directamente Som Energia, debes contestar este correo y darnos el consentimiento para dar de baja tu contrato (número ${object.polissa_id.name}), del punto de suministro situado en c.${object.cups_id.direccio}. De esta manera la distribuidora te asignará una comercializadora de referencia y podrás acogerte a los beneficios que te hemos comentado.<br/>
<br/>
Si en la mayor brevedad no pasas este contrato a la comercializadora de referencia, empezaremos el protocolo de corte de suministro.<br/>
<br/>
Te recuerdo la deuda pendiente:<br/>
<br/>

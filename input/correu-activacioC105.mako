...
% endif
<p>Si vols consultar les dades del contracte, fer gestions i veure totes les teves factures, pots fer-ho a trav&eacute;s de la teva <a href="https://oficinavirtual.somenergia.coop/ca/login/">Oficina Virtual</a>.</p>

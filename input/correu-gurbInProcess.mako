...
<p class="f-fallback" style="line-height: 1.5;">Reps aquest correu en relació amb el projecte ${object.gurb_cau_id.gurb_group_id.name} al qual t'has inscrit.</p>
<p class="f-fallback" style="line-height: 1.5;">En aquest moment iniciem els tràmits de modificació del teu contracte per l’aplicació de l’autoproducció col·lectiva, és a dir, per tal que puguis començar a rebre l’energia procedent de la instal·lació fotovoltaica.</p>
...
<p>Quan tinguem la confirmació per part de la distribuïdora t'enviarem un correu electrònic indicant la data exacta d'activació de la modificació i, per tant, quan començaràs a rebre l’energia de les plaques.</p>
<p>Moltes gràcies per la paciència! Ja queda menys!</p>
<p>Salutacions,</p>
...
<th style="height: 91.25px;" align="right"><span style="font-weight: 400;"><img style="height: 85px;" src="https://www.somenergia.coop/logo/logo_fosc_100px.png" alt="SOM Energia"></span></th>
...
<td class="content-cell">
<p class="f-fallback" style="line-height: 1.5;"><br>Hola, ${object.partner_id.name},</p>
<p class="f-fallback" style="line-height: 1.5;">Recibes este correo en relación con el proyecto ${object.gurb_cau_id.gurb_group_id.name} al que te has inscrito.</p>
<p>En este momento iniciamos los trámites de modificación de tu contrato para la aplicación de la autoproducción colectiva, es decir, para que puedas empezar a recibir la energía procedente de la instalación fotovoltaica.</p>
...
<p>Cuando tengamos la confirmación por parte de la distribuidora te enviaremos un correo electrónico indicando la fecha exacta de activación de la modificación y, por lo tanto,  cuando empezarás a recibir energía de las placas.</p>
<p>Muchas gracias por tu paciencia! Ya queda menos!</p>
<p>Saludos,</p>

...
<p>T'enviem, per si és del teu interès, el comunicat dels rendiments obtinguts i les retencions aplicades en relació a les teves inversions en títols participatius de SOM ENERGIA durant l'any ${previous_year}.</p>
...
<p>Te enviamos, por si es de tu interés, comunicado de los rendimientos obtenidos y retenciones aplicadas en relación a tus inversiones en títulos participativos de SOM ENERGIA durante el año ${previous_year}.</p>

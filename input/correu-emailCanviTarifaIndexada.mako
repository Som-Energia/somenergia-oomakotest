...
<%def name="correu_cat()">
    ...
    <body>
        <p>Hem rebut una sol·licitud de modificació del contracte ${object.name} amb Som Energia:</p><br>
        <br>
        ...
        <p><b>Informació rellevant en el procés de contractació:</b></p> <br>
...
<%def name="correu_es()">
    ...
    <body>
      ...
      <p><b>Información referente al proceso de contratación:</b></p><br>

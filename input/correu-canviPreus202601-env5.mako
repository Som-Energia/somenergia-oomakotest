...
<figure class="table">
    <table style="background-color: #FBD9AD; border: 4px solid #a18100; padding-top: 1em;padding-left: 2em;padding-right: 2em;padding-bottom: 1em;">
        <tbody>
            <tr>
                <td>
                    <p>
                      <span style="font-weight: 400;text-align: left;">
                        <p>
                          El correu en què t’informàvem del canvi de preus que aplicarem a partir de l’1 de gener (amb el títol <i>Al gener modificarem les tarifes d’electricitat</i>) tenia un petit error. L’arxiu adjunt no contenia els nous preus, sinó els preus vigents actualment. La resta d’informació que et donàvem al correu, les explicacions i els preus que hi havia al cos del correu, són correctes.
                        </p>
                        <p>
                          T’enviem, altre cop, el teu contracte actualitzat amb els nous preus, que seran d’aplicació a partir de l’1 de gener de 2026.
                        </p>
                        <p>
                          Ens disculpem per les molèsties que aquest error t'hagi pogut ocasionar.
                        </p>
                      </span>
                    </p>
                </td>
            ...
            <tr>
                <td>
                    <p>
                      <span style="font-weight: 400;text-align: left;">
                        <p>
                          El correo en el que te informábamos del cambio de precios que aplicaremos a partir del 1 de enero (con el título <i>En enero modificaremos las tarifas de electricidad</i>) tenía un pequeño error. El archivo adjunto no contenía los nuevos precios, sino los precios actualmente vigentes. El resto de información que te dábamos en el correo, las explicaciones y los precios que había en el cuerpo del correo, son correctos.
                        </p>
                        <p>
                          Te enviamos, de nuevo, tu contrato actualizado con los nuevos precios, que serán de aplicación a partir del 1 de enero de 2026.
                        </p>
                        <p>Lamentamos las molestias que este error te haya podido causar.</p>
                      </span>
                    </p>
                </td>
            </tr>

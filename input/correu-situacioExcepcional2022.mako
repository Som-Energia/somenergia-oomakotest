...
Ens posem en contacte amb tu perquè hem revisat el teu contracte i hem detectat un error en l'aplicació de l'IESE establerta pel govern el 16/09/2021.<br>
<br>
...
<br>
En els pròxims dies veuràs diversos moviments al compte, corresponent a la correcció de les factures esmentades. El resultat final és una diferència de ${diff_amount} € a favor teu.<br>
<br>
...
% endif
% if  object.titular.lang != "ca_ES":
Nos ponemos en contacto contigo porque hemos revisado tu contrato y hemos detectado un error en la aplicación del descuento en el IESE establecida por el gobierno el 16/09/2021.<br>
<br>
...
<br>
Durante los próximos días verás varios movimientos en tu cuenta correspondiente a la corrección de dichas facturas. El resultado total final es una diferencia de ${diff_amount} € a tu favor.<br>
<br>
